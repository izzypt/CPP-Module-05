...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/03 16:09:25 by pshevche          #+#    #+#             */
/*   Updated: 2023/12/03 16:09:27 by pshevche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ShrubberyCreationForm::execute(const Bureaucrat &executor) const {
    ...
    std::cout << "Executing ShrubberyCreationForm for " << _target << " by " << executor.getName() << std::endl;
